      ...
      {!exercise.isBW && (
        <div className="flex items-center gap-2 mb-4">
          <input type="number"
            ...
            className="w-20 px-3 py-2 bg-base border border-surface-border rounded-xl text-white text-sm text-center focus:ring-1 focus:ring-accent/50 focus:border-accent/30 transition-all" />
          ...
          <button onClick={() => onFillAll(exercise, dayName, Number(fillWeight) || exercise.weight)} disabled={saving}
            className="ml-1 px-3 py-2 rounded-xl bg-accent/15 text-accent text-xs font-bold hover:bg-accent/25 transition-all flex items-center gap-1.5">
